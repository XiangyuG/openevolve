...
# Each entry: initial-program filename (for reference/docs), runner binary
# name in LIBBPF_TOOLS_DIR, an argv builder, and the output shape the runner
# prints ("table" for multi-program stats rows, "single" for a one-block
# run_cnt/run_time_ns delta).
TOOLS = {
    "filetop": {
